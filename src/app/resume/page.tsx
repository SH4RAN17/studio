          ...
          <div className="mt-48 pt-24 border-t border-white/5">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
              <div>
                ...
                <a href="https://wa.me/+918828691247?text=Hi%20I%20saw%20your%20portfolio" className="inline-block py-4 px-12 bg-primary text-primary-foreground hover:bg-primary/90 transition-all font-medium uppercase tracking-widest text-sm">
                  Send Message
                </a>
              </div>
